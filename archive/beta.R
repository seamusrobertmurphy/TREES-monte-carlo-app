...
ui <- dashboardPage(
  ...
  dashboardBody(
  	#theme = bs_theme(version = 5, bootswatch = "minty"),  # shinydashboard incompatible with bslib
    tags$head(
      tags$style(HTML("
        ...
        /* Minty-inspired colors */
        .skin-blue .main-header .logo { background-color: #78C2AD; }
        .skin-blue .main-header .navbar { background-color: #78C2AD; }
        .box.box-primary { border-top-color: #78C2AD; }
        .btn-primary { background-color: #78C2AD; border-color: #78C2AD; }        
      "))
    ),
